...
export const imagePrompts: Prompt[] = [
  ...
  { text: "Playful group of cartoon animals having a picnic in a sunny meadow, vibrant colors, friendly expressions, disney/pixar style", guidance: "Ideal for cheerful, family-friendly, or branded character illustrations." },
  { text: "Moody gothic library with towering bookshelves, floating candles, and a mysterious cloaked figure reading, dark romantic atmosphere", guidance: "Great for dark fantasy, mystery, or atmospheric storytelling visuals." },
  { text: "Sleek modern sports car speeding on a coastal highway at sunset, motion blur, vibrant reflections, luxury automotive photography", guidance: "Excellent for dynamic product, lifestyle, or advertising shots." },
  { text: "Enchanted forest with glowing mushrooms, fireflies, and a hidden fairy village, soft magical lighting, storybook watercolor style", guidance: "Perfect for whimsical, nature-magic, or fantasy illustration." },
  { text: "Intense close-up portrait of a warrior with battle scars, dramatic side lighting, gritty realism mixed with painterly texture", guidance: "Strong for character development, game art, or emotional storytelling." },
  { text: "Minimalist scandinavian interior with large windows overlooking snowy mountains, natural light, cozy textures, calm and inviting", guidance: "Ideal for interior design, lifestyle, or real estate visuals." },
  { text: "Bustling alien marketplace on a distant planet, exotic creatures, glowing stalls, vibrant sci-fi concept art style", guidance: "Great for world-building, game design, or imaginative sci-fi scenes." },
  { text: "Elegant black and white photograph of a jazz band in a smoky 1950s club, dramatic lighting, timeless and moody composition", guidance: "Perfect for vintage, music, or sophisticated editorial work." },
  { text: "Explosive action scene of a superhero leaping between skyscrapers, dynamic motion, vibrant comic book colors, high energy", guidance: "Excellent for dynamic, high-impact superhero or action visuals." },
  { text: "Peaceful autumn forest path covered in golden leaves, soft sunlight filtering through trees, warm and nostalgic atmosphere", guidance: "Great for seasonal, nature, or reflective lifestyle photography." },
  { text: "Intricate steampunk mechanical bird with brass gears and feathers, highly detailed close-up, victorian adventure aesthetic", guidance: "Ideal for detailed creature design or mechanical fantasy art." },
];
